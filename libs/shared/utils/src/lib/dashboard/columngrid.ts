...
import { LazycellrendererDirective } from './lazycellrenderer.directive';
import * as moment from 'moment';


@Component({
    selector: 'lps-column-definition',
    template: ``,
})
export class ColumnDefinitionComponent{

    @ViewChild(LazycellrendererDirective, { static: true }) lpsLazycellrendererHost!: LazycellrendererDirective;
    ...
    constructor(
        ...
        @Inject('eGui') eGui: HTMLDivElement){
            this.elGui = eGui;
            this.dbInfo = i;
        }
    ...
    private setCompLoaderTextField(el:any){
        const txtFld = {
            headerName: el.headerName,
            // cellRenderer: ()=> {
            //     return el.cellRenderer;
            // },
            cellRenderer: (params:any)=> {
                return `<ng-template lpsLazycellrendererHost></ng-template>`;    
            },
            field: el.field,            
            // sortable: true,
            // enableRowGroup: true,
    ...
    private setCustomLinkField(el:any) {
        ...
        headerName: el.headerName,
        field: el.field,
        // cellRenderer: (params:any)=> {<ng-template #lazyComponent></ng-template>
    ...
    fieldMapper(element:any) {
        ...
        const mapper:any = {
            ...
            "CompLoaderTextField": this.setCompLoaderTextField(element),
