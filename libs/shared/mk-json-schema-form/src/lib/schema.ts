...
export interface Schema {
     ...
     */
    type?: 'boolean' | 'string' | 'array' | 'number' | 'integer' | 'object' | 'checkboxGroup';
     ...
     */
    widget?: 'select' | 'radio' | 'upload' | 'upload64' | 'date' | 'textarea' | 'password' | 'color' |
    'datetime-local' | 'email' | 'month' | 'tel' | 'time' | 'url' | 'week' | 'custom' | 'checkbox';
     ...
     */
    layout?: 'tab' | 'table' | 'vertical' | 'horizontal' | 'select' | 'chips' | 'checkbox';
