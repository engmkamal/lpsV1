...
export class BaseComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (this.state.schema.type === 'object' || this.state.schema.type === 'checkboxGroup') {
  ...
  static createControl(schema: Schema, value: any, required: boolean): AbstractControl {
    if (schema.type === 'object' || schema.type === 'checkboxGroup') {
  ...
  static prepareControl(control: AbstractControl, schema: Schema, value: any, required: boolean) {
    ...
    if (schema.type !== 'object' && schema.type !== 'array' && schema.type !== 'checkboxGroup')
