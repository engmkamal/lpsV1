...
@Component({
  selector: 'lps-sectionrenderer',
  templateUrl: './sectionrenderer.component.html',
  styleUrl: './sectionrenderer.component.scss',
  encapsulation: ViewEncapsulation.Emulated,
})
export class SectionrendererComponent implements OnInit, OnDestroy, AfterViewInit, AfterViewChecked, ICellRendererAngularComp, OnChanges {
  ...
  examples: { [key: string]: { description: string, value: any, schema: Schema } } =
    {
      ...
      metaschema: {
        ...
        value: SectionrendererComponent.schemaExample,
        schema: SectionrendererComponent.metaschema
      }
  };
  ...
  ngOnInit(): void {
    ...
    // this.form.addControl('child', this.state.control);
