...
@Component({
  selector: 'lps-formwidgets',
  templateUrl: './formwidgets.component.html',
  styleUrl: './formwidgets.component.scss',
})
export class FormwidgetsComponent implements OnInit, AfterViewInit, AfterViewChecked {
  ...
  rowData$!: Observable<any[]>;
    ...
    dashboardGridDef(){   
      return new Promise((resolve, reject)=>{
        ...
        this.mpTG.detailCellRenderer = 'fieldrenderer';
        ...
        this.mpTG.detailCellRendererParams = {
            ...
            columnDefs: [
              {
                ...
                field: 'control',
                cellRenderer: WidgetrendererComponent, 
          ...
          template: (params:any)=>{
            return `<div style="height: 100%; background-color: #D6EAF8; padding: 20px; box-sizing: border-box;">
              <div style="height: 10%; padding: 2px; font-weight: bold;"># Preview:</div>
    ...
    othersColDef() {
      ...
      const widgetTitleFld = {
        headerName: "Field/Widget Name",
        field: "groupTitle",
        editable:false,
        minWidth: 200, 
        maxWidth: 250,
      ...
      const sectionDdlFld = {
        headerName: "Navigation/Display Section",
        field: "section",
        cellEditor: 'agRichSelectCellEditor',
        cellEditorParams: {
          values: this.getSectionFromServer(),
          allowTyping: true,
          filterList: true,
          highlightMatch: true,
          valueListMaxHeight: 200,
          valueListMaxWidth: 250
        },
        minWidth: 220, 
        maxWidth: 250,
        filter: true,
      ...
      const displayOrderFld = {
        headerName: "Display Order",
        field: "displayOrder",
        cellEditor: 'agRichSelectCellEditor',
        cellEditorParams: {
          values: this.displayOrderFromServer(),
          allowTyping: true,
          filterList: true,
          highlightMatch: true,
          valueListMaxHeight: 200,
      ...
      return new Promise((resolve, reject)=>{ 
        this.mpTG.columnDefs.push(widgetTitleFld);   
        this.mpTG.columnDefs.push(sectionDdlFld);
        this.mpTG.columnDefs.push(displayOrderFld);
  ...
  getSectionFromServer(params?: ICellEditorParams): Promise<string[]> {
    return new Promise((resolve) => {
      setTimeout(() => resolve([
        'Preliminary Information', 'Optional Preliminary Information', 'Client Details', 'Optional Client Details', 'Income & Expenditure', 'Optional Income & Expenditure', 
        'Assets and Liabilities', 'Optional Assets and Liabilities', 'Proposed Facility', 'Optional Proposed Facility',
        'Existing Facility', 'Collateral Security', 'Primary Security', 'Guarantor', 'Insurance', 'Sanction History', 'Down Payment Table',
        'Write Off Table', 'Interest Waiver Table', 'Suit File Table', 'Legal Steps', 'CIB', 'Working Capital Assessment', 'Business Received',
        'Earning Received', 'Repayment Behavior', 'Transaction Behavior', 'Cost of Project Existing/ Projected', 'Financial Analysis', 'ICRRS'
      ]), 1000);
    });
  }

  displayOrderFromServer(params?: ICellEditorParams): Promise<number[]> {
    return new Promise((resolve) => {
      setTimeout(() => resolve([
