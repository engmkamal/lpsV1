(app.controller("CPRDashboardCtrl", function ($scope, $http, $timeout) {
    ...
    function GetAllCPRRequestDurationList() {
        try {
            $http({
                url: "/Report/GetAllCPRRequestDurationList",
                method: "POST",
                headers: {
        ...
        Chart.pluginService.register({
            beforeDraw: function (chart) {
                if (chart.config.options.plugin_one_attribute2) {
                    ...
                    var cal = ($scope.Completed) / ($scope.Types.Draft + $scope.Types.Rejected + $scope.Types.InProgress + $scope.Types.Completed) * 100;
    ...
    function GetDetailsOfTheAuthor() {
        ...
        try {
            $http({
                url: "/Report/GetRequestCountWithAuthor",
                method: "POST",
                headers: {
                    "accept": "application/json;odata=verbose",
                    "content-Type": "application/json;odata=verbose"
    ...
    function GetRequestDuration(cPRNo) {
        try {
            $http({
                url: "/Report/GetRequestDurationByCPRNo",
                method: "POST",
                headers: {
                    "accept": "application/json;odata=verbose",
                    "content-Type": "application/json;odata=verbose"
    ...
    function SearchByCPRNo() {
        try {
            ...
            if ($scope.status !== false) {
                $http({
                    url: "/Report/SearchRequestDurationByCPRNo",
                    method: "POST",
                    headers: {
                        "accept": "application/json;odata=verbose",
                        "content-Type": "application/json;odata=verbose"
