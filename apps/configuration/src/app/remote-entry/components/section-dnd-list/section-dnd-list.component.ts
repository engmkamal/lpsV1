...
import { JLane, JIssue } from '../../interface/section';
import {
  CdkDragDrop,
  moveItemInArray,
  transferArrayItem
...
@Component({
  selector: '[section-dnd-list]',
  templateUrl: './section-dnd-list.component.html',
  styleUrls: ['./section-dnd-list.component.scss'],
  encapsulation: ViewEncapsulation.Emulated
})
export class SectionDndListComponent implements OnInit {
  @Input() lane: JLane;
