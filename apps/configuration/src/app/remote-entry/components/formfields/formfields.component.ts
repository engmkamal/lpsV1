...
import { NgxLoadingService, SharepointlistService } from '@lps/service';
...
export class FormfieldsComponent implements OnInit, AfterViewInit, AfterViewChecked {
  ...
  rowData$!: Observable<any[]>;
    ...
    public ngxLoadingService = Inject(NgxLoadingService);
  ...
  public config = {
    ...
    async ngOnInit() {
      ...
      this._actRoute.data.subscribe(({ formfields }) => {
        // do something with your resolved data ...
        this.allFormfields = formfields;
      });

      this._showLoaderEvents$ = this._router.events
      .pipe(
      ...
      this.isLoading$.subscribe((load)=>{
        this.ngxLoadingService.loading = load;
      })
